package itla.hope.main;

import itla.hope.capture.RegisterFace;
import itla.hope.records.Data;
import itla.hope.recognizer.RecognizeFace;
import itla.hope.util.ConectaBanco;
import itla.hope.util.RoundImage;
import itla.hope.util.ChartDaily;
...
public class Menu extends javax.swing.JFrame {
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        if (desktop != null && desktop.isSupported(Desktop.Action.BROWSE)) {
            try {
                URI site = new URI("https://github.com/AlucardX14");
                desktop.browse(site);
